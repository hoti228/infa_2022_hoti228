...
def game(X_, Y_, colors_, sizes_, speeds_x_, speeds_y_, delta_t=1000/FPS, T=20000):
    ...
    while True and time_long < T:
        ...
        for i in range(q):
            ...
            X[i] += speeds_x[i]*30/FPS
            Y[i] += speeds_y[i]*30/FPS
        ...
        time_long += 1000/FPS # учет прошедшего промежутка времени
    return count


def enter_nickname(text_color=(255, 255, 255), screen_color=(0, 0, 0), nick_color=(255, 255, 0)):
    '''
